...
//(*IdInit(mmAbout)
const long mmAbout::ID_STATICBITMAP1 = wxNewId();
const long mmAbout::ID_STATICTEXT1 = wxNewId();
const long mmAbout::ID_TEXTCTRL2 = wxNewId();
const long mmAbout::ID_TEXTCTRL3 = wxNewId();
const long mmAbout::ID_TEXTCTRL1 = wxNewId();
//*)

BEGIN_EVENT_TABLE(mmAbout,wxDialog)
	//(*EventTable(mmAbout)
	//*)
END_EVENT_TABLE()

mmAbout::mmAbout(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	//(*Initialize(mmAbout)
	...
	StaticBitmap1 = new wxStaticBitmap(this, ID_STATICBITMAP1, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_INFORMATION")),wxART_CMN_DIALOG), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICBITMAP1"));
	BoxSizer2->Add(StaticBitmap1, 2, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _("MMODA"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
